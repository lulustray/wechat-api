 ...
 * @param {Function} callback 回调函数
 */
exports.getOnlineKfList = function (callback) {
  this.preRequest(this._getOnlineKfList, arguments);
};

/*!
 * 获取在线客服接待信息的未封装版本
 */
exports._getOnlineKfList = function (callback) {
  // https://api.weixin.qq.com/cgi-bin/customservice/getonlinekflist?access_token=ACCESS_TOKEN
  var prefix = 'https://api.weixin.qq.com/cgi-bin/';
  var url = prefix + 'customservice/getonlinekflist?access_token=' + this.token.accessToken;
